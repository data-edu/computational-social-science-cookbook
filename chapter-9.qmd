...
![](<data/ch9_images/Educational Researcher.png>)
...
![](<data/ch9_images/arxiv.png>)

![](<data/ch9_images/osf.png>)
...
![](<data/ch9_images/quarto .png>)

*Example of a Quarto-based project website format.*
...
![](data/ch9_images/ch2-simple-frequency-example.png)
...
To make this concrete, we use the public `data-edu/tidyLPA` repository as an example communication workflow [@Rosenberg2018tidyLPA]:

<https://github.com/data-edu/tidyLPA>

In this workflow, the **source layer** is the GitHub repository (Quarto files, scripts, commit history, documentation), and the **public layer** is the rendered GitHub Pages site. Together, these two layers provide a stable, citable, and transparent communication artifact for computational educational research.

<https://data-edu.github.io/tidyLPA>

![](<data/ch9_images/github repo codes.png>)

![](<data/ch9_images/github page.png>)

*Example of the `data-edu/tidyLPA` source repository and its published GitHub Pages output.*
...
## 9.7 Summary and Communication Checklist
