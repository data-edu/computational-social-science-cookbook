...
Computational approaches enable educational researchers to analyze increasingly complex and large-scale data. However, the value of these analyses ultimately depends on how clearly and responsibly findings are communicated [@Wilke2019DataViz]. Communication is not a final step added after analysis — it is an integral part of making research meaningful, interpretable, and usable [@Gopen1990ScienceWriting].
...
![Figure 9.1. Traditional journal publication interface for educational research.](<data/ch9_images/Educational Researcher.png>)
...
![Figure 9.2. arXiv preprint platform interface for rapid dissemination.](<data/ch9_images/arxiv.png>)

![Figure 9.3. Open Science Framework interface for open project sharing.](<data/ch9_images/osf.png>)
...
-   Hosting source files and code on **GitHub** (<https://github.com/>)
    ...
    ![Figure 9.4. GitHub repository view for source code and project files.](<data/ch9_images/github repo codes.png>)

    *Figure. `data-edu/tidyLPA` source repository on GitHub.*

-   Publishing a static website using **GitHub Pages** (<https://pages.github.com/>)

    ![Figure 9.5. GitHub Pages site view for public project communication.](<data/ch9_images/github page.png>)

    *Figure. `data-edu/tidyLPA` published GitHub Pages site.*
...
![Figure 9.6. Quarto-rendered web page example for research communication.](<data/ch9_images/quarto .png>)
...
![Figure 9.7. Zenodo archive interface with DOI-based research outputs.](<data/ch9_images/zenodo.png>)
...
![Figure 9.8. Simple frequency bar chart adapted from Chapter 2 policy analysis.](data/ch9_images/ch2-simple-frequency-example.png)
