...
-   **Chapter 7** will demonstrate *thematic and qualitative text analysis* using **LM Studio**,

    showing how local LLMs can perform end-to-end qualitative coding and synthesis.

-   **Chapter 8** extends this workflow to *multimodal data*—images — illustrating how AI can connect diverse data types in educational contexts.