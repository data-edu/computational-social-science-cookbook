---
title: "Cloud vs Local LLMs"
---

## 5.1 Overview

Large Language Models (LLMs) are now central to many research workflows in education, especially where analysis depends on large volumes of natural language data [@Kasneci2023ChatGPT; @Liu2025GPT4Coding; @OpenAI2023GPT4]. Traditional NLP methods remain essential for transparent counting, comparison, and baseline modeling, but LLMs add complementary capabilities for context-sensitive synthesis, interpretation, and generation [@Than2025UpdatingCoding; @Nelson2021FutureCoding; @Bommasani2021FoundationModels].
...
Table: Table 5.1. Major cloud LLM providers and R access options. \| Provider \| Example Models \| Access \| R / HTTP Wrapper \| \|------------------\|-------------------\|------------------\|------------------\| \| **OpenAI** \| GPT-4o / GPT-5 \| API key via [platform.openai.com](https://platform.openai.com) \| `{httr2}`, `{openai}`, `{ellmer}` \| \| **Anthropic** \| Claude 3 Opus · Claude 4 \| API key via [console.anthropic.com](https://console.anthropic.com) \| `{httr2}`, `{anthropic}`, `{ellmer}` \| \| **Google** \| Gemini 2.5 · Gemini Ultra (2025) \| [AI Studio](https://aistudio.google.com) \| `{googleGenerativeAI}`, `{ellmer}` \| \| **Mistral AI** \| Mixtral 8×22B · Mistral 7B v0.3 \| [mistral.ai](https://mistral.ai) \| HTTP via `{httr2}` \| \| **DeepSeek** \| DeepSeek-V3.1 (MoE 128K ctx) \| API via [deepseek.ai](https://deepseek.ai) \| HTTP via `{httr2}` \|
...
Table: Table 5.2. Core LM Studio features for local LLM workflows. \| Feature \| Description \| \|---------------------------------------------------\|--------------------\| \| Local LLMs \| Run models offline on your own machine \| \| Chat Interface \| Simple prompt-based GUI \| \| Document Chat (RAG) \| Offline "chat with your PDFs" \| \| Model Management \| Search, download, and switch models \| \| API Access \| OpenAI-compatible REST endpoints \| \| Community Support \| Active [Discord](https://discord.gg/uwMphZmHqY) and docs \|
...
Table: Table 5.3. Comparison of cloud and local LLM workflows. \| Criterion \| Cloud-based LLMs \| Local LLMs \| \|------------------------\|------------------------\|------------------------\| \| **Cost** \| Pay-per-token or subscription \| Free (after hardware) \| \| **Privacy** \| Data sent to provider \| Data stays local \| \| **Performance** \| Highest accuracy & speed \| Depends on hardware \| \| **Maintenance** \| Automatic updates \| Manual model management \| \| **Customization** \| Limited fine-tuning \| Fully modifiable \| \| **Best for** \| Large public datasets or prototype analysis \| Sensitive or regulated data \|
...
Table: Table 5.4. Recommended LLM environment by research use case. \| Use Case \| Cloud LLM \| Local LLM \| \|-----------------------------\|-----------\|-----------\| \| Rapid prototyping \| ✅ \| ⚪ \| \| Large-scale text processing \| ✅ \| ⚪ \| \| Sensitive student data \| ⚪ \| ✅ \| \| Offline analysis \| ⚪ \| ✅ \| \| Long-term reproducibility \| ⚪ \| ✅ \|
