...
### 5.2.4 Example 3: Collecting SNA Data via Surveys
...
## 5.3 Network Management & Measurement in Social Network Analysis

### 5.3.1 Purpose and Case
...
### 5.3.2 Sample Research Questions
...
# 8. Print summary statistics (structured output)
dlt2_stats <- data.frame(
  metric = c(
    "Nodes", "Edges",
    "Degree Centralization (all)",
    "Degree Centralization (in)",
    "Degree Centralization (out)",
    "Density", "Reciprocity",
    "Transitivity", "Diameter", "Mean Distance"
  ),
  value = c(
    num_nodes, num_edges,
    centr_all, centr_in, centr_out,
    density, recip,
    trans, diam, mean_d
  )
)
