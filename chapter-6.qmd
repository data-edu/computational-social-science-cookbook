...
![Figure 6.1. Positron Assistant panel in the research coding workflow.](data/ch6_images/assistant-panel-overview.png)
...
![Figure 6.2. Positron setting to enable Assistant in the IDE.](data/ch6_images/assistant-enable-setting.png)
...
![Figure 6.3. Assistant preference options for response style and coding defaults.](data/ch6_images/assistant-preferences.png)
...
1.  **Start in Positron and define local-model JSON settings first.**
    ...
    ![Figure 6.4. Positron JSON settings for local LM Studio endpoint configuration.](<data/ch6_images/Positron_LMstudio_JSON settings.png>)
...
2.  **Set up LM Studio and confirm the local server is running.**
    ...
    ![Figure 6.5. LM Studio local server setup for Positron integration.](<data/ch6_images/LMstudio—Positron set up.png>)
...
3.  **Configure Continue in Positron to use the LM Studio endpoint.**
    ...
    ![Figure 6.6. Continue extension settings mapped to the LM Studio local model.](<data/ch6_images/Continue_LMstudio Settings.png>)

    If your Continue workflow is YAML-based, configure the same endpoint and model there as well:

    ![Figure 6.7. Continue YAML configuration for local model endpoint and provider mapping.](<data/ch6_images/Continue—yml.png>)
...
4.  **Run a quick in-IDE verification prompt.**
    ...
    ![Figure 6.8. In-IDE verification prompt using Positron Assistant with LM Studio.](<data/ch6_images/Positron Assitant—LMstudio UI.png>)
...
5.  **Run one concrete case example before using the workflow in research analysis.**
    ...
    ![Figure 6.9. Case example response from Positron Assistant using a local model.](<data/ch6_images/Positron Assitant——LMstudio case example.png>)
...
![Figure 6.10. Assistant-generated plain-language explanation of selected code.](data/ch6_images/assistant-code-explanation.png)
...
![Figure 6.11. Assistant debugging suggestion for a code error in context.](data/ch6_images/assistant-debug-suggestion.png)
...
![Figure 6.12. Databot-generated reusable import template for recurring datasets.](data/ch6_images/databot-import-template.png)
...
![Figure 6.13. Databot-generated data validation checks for incoming survey files.](data/ch6_images/databot-validation-checks.png)
...
![Figure 6.14. End-to-end AI-assisted workflow from import to validation and exploratory output.](data/ch6_images/complete-workflow-positron.png)
