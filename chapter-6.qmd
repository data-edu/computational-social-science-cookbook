...
<!-- JR: Broken record, but we need to cite some sources/examples here, including the Nelson future of coding piece (the one that mentions LLMs, and other papers using LLMs for reserach - see ryan baker's work and others) -->
