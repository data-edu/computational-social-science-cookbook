...
You don't need to master all of these immediately. Most data work relies heavily on `dplyr` and `ggplot2`, with the others playing supporting roles as needed.
