...
The tidyverse is a collection of R packages designed for data science with a shared philosophy: code should be readable, consistent, and focused on the data transformations you're actually trying to accomplish [@Wickham2017R4DS; @Wickham2019Tidyverse]. If you've struggled with base R's sometimes cryptic syntax, the tidyverse may feel like a relief.
