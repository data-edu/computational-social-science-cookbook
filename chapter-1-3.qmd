...
The tidyverse is a collection of R packages designed for data science with a shared philosophy: code should be readable, consistent, and focused on the data transformations you're actually trying to accomplish. If you've struggled with base R's sometimes cryptic syntax, the tidyverse may feel like a relief.

<!-- JR: I think we need to cite the book introducing tidyverse (Wickham's book - R for Data Science) -->

Most computational educational research workflows rely on tidyverse packages for data manipulation, visualization, and modeling. Learning this ecosystem means learning the tools your collaborators use, the examples you'll find online, and the approaches that scale from quick exploration to publication-ready analysis.
...
This is the dataset we'll use in the examples below. It represents the kind of educational data you'll work with in computational educational research: thousands of observations with both categorical and continuous variables.
