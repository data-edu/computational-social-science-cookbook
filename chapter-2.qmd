...
<!-- JR: I feel we need citations for some of these - a qual book, for instances, and some examples of pattern recognition and examples of time-intensitivity and rich results. Lastly what traditional methods are. We need to support these claims. EDIT: I see we cite Saldana below - good - draw that out and cite that here in the overview! -->

In many social science fields, analyzing text data is typically considered to be the work of qualitative researchers. Traditionally, qualitative research involves identifying patterns in non-numeric data, and this pattern recognition is typically done manually. This process is time-intensive but can yield rich research results. Traditional methods for analyzing text data involve human coding and can include direct (e.g., books, online texts) or indirect sources (e.g., interview transcripts).
...
<!-- JR: This seems very general and like it belongs elsewhere - like in the intro. Cut or move? -->

## Disclaimer

While resources are available that discuss these analysis methods in depth, this book aims to provide a practical guide for social scientists, using data they will likely encounter. Our goal is to present a "field guide" for guiding research projects through real-world examples.
:::
...
<!-- JR: This is a little nuanced. The terms of service are just the terms that we have to follow to stay in a company's good graces - I don't think there is anything legal at play in most cases --- just getting booted from a platform. The answer here is to cite some sources on this, I think. -->
...
<!-- JR: What does REST stand for? How is it different from other APIs? -->
...
<!-- JR: we may want to add a note that this is often not the most effective viz of counts of words - I believe a bar chart may often be easier, though these are fun. There are some sources on this; we used one in STEM 691 (I can't remember the title and am on the plane right now - the book by Clause Wilke). -->
