...
![Figure 11.1. Traditional journal publication interface for educational research.](<data/ch9_images/Educational Researcher.png>)
...
-   Hosting source files and code on **GitHub** (<https://github.com/>)
    ...
    ![Figure 11.4. GitHub repository view for source code and project files.](<data/ch9_images/github repo codes.png>)


-   Publishing a static website using **GitHub Pages** (<https://pages.github.com/>)

    ![Figure 11.5. GitHub Pages site view for public project communication.](<data/ch9_images/github page.png>)
...
![Figure 11.6. Quarto-rendered web page example for research communication.](<data/ch9_images/quarto .png>)
